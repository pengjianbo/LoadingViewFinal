 ...
 * Date:16/3/9 下午5:21
 */
public class NewGameGridAdapter extends ViewHolderAdapter<NewGameGridAdapter.NewGameViewHolder, GameInfo> {
    ...
    public NewGameViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = inflate(R.layout.adapter_grid_item, parent);
